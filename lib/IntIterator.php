...
class IntIterator {
	...
	public function __construct ($min, $max) {
		#/opt/haxe/std/IntIterator.hx:46: characters 3-17
		$this->min = $min;
		#/opt/haxe/std/IntIterator.hx:47: characters 3-17
		$this->max = $max;
	}
	...
	public function hasNext () {
		#/opt/haxe/std/IntIterator.hx:54: characters 3-19
	...
	public function next () {
		#/opt/haxe/std/IntIterator.hx:63: characters 3-15
		return $this->min++;
	}
}
