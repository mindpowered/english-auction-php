...
class Math {
	...
	public static function abs ($v) {
		#/opt/haxe/std/php/_std/Math.hx:34: characters 3-23
		return abs($v);
	}
	...
	public static function acos ($v) {
		#/opt/haxe/std/php/_std/Math.hx:79: characters 3-24
		return acos($v);
	}
	...
	public static function asin ($v) {
		#/opt/haxe/std/php/_std/Math.hx:76: characters 3-24
		return asin($v);
	}
	...
	public static function atan ($v) {
		#/opt/haxe/std/php/_std/Math.hx:73: characters 3-24
		return atan($v);
	}
	...
	public static function atan2 ($y, $x) {
		#/opt/haxe/std/php/_std/Math.hx:49: characters 3-28
		return atan2($y, $x);
	}
	...
	public static function ceil ($v) {
		#/opt/haxe/std/php/_std/Math.hx:70: characters 10-36
		return (int)(ceil($v));
	}
	...
	public static function cos ($v) {
		#/opt/haxe/std/php/_std/Math.hx:46: characters 3-23
		return cos($v);
	}
	...
	public static function exp ($v) {
		#/opt/haxe/std/php/_std/Math.hx:55: characters 3-23
		return exp($v);
	}
	...
	public static function fceil ($v) {
		#/opt/haxe/std/php/_std/Math.hx:100: characters 3-24
		return ceil($v);
	}
	...
	public static function ffloor ($v) {
		#/opt/haxe/std/php/_std/Math.hx:97: characters 3-25
		return floor($v);
	}
	...
	public static function floor ($v) {
		#/opt/haxe/std/php/_std/Math.hx:67: characters 10-37
		return (int)(floor($v));
	}
	...
	public static function fround ($v) {
		#/opt/haxe/std/php/_std/Math.hx:94: characters 3-31
		return floor($v + 0.5);
	}
	...
	public static function isFinite ($f) {
		#/opt/haxe/std/php/_std/Math.hx:91: characters 3-29
		return is_finite($f);
	}
	...
	public static function isNaN ($f) {
		#/opt/haxe/std/php/_std/Math.hx:88: characters 3-26
		return is_nan($f);
	}
	...
	public static function log ($v) {
		#/opt/haxe/std/php/_std/Math.hx:58: characters 3-23
		return log($v);
	}
	...
	public static function max ($a, $b) {
		#/opt/haxe/std/php/_std/Math.hx:40: characters 10-55
		if (is_nan($a) || is_nan($b)) {
			#/opt/haxe/std/php/_std/Math.hx:40: characters 33-36
			return Math::$NaN;
		} else {
			#/opt/haxe/std/php/_std/Math.hx:40: characters 39-55
			return max($a, $b);
		}
	}
	...
	public static function min ($a, $b) {
		#/opt/haxe/std/php/_std/Math.hx:37: characters 10-55
		if (is_nan($a) || is_nan($b)) {
			#/opt/haxe/std/php/_std/Math.hx:37: characters 33-36
			return Math::$NaN;
		} else {
			#/opt/haxe/std/php/_std/Math.hx:37: characters 39-55
			return min($a, $b);
		}
	}
	...
	public static function pow ($v, $exp) {
		#/opt/haxe/std/php/_std/Math.hx:82: characters 3-28
		return ($v ** $exp);
	}
	...
	public static function random () {
		#/opt/haxe/std/php/_std/Math.hx:85: characters 3-51
	...
	public static function round ($v) {
		#/opt/haxe/std/php/_std/Math.hx:64: characters 10-43
	...
	public static function sin ($v) {
		#/opt/haxe/std/php/_std/Math.hx:43: characters 3-23
		return sin($v);
	}
	...
	public static function sqrt ($v) {
		#/opt/haxe/std/php/_std/Math.hx:61: characters 3-24
		return sqrt($v);
	}
	...
	public static function tan ($v) {
		#/opt/haxe/std/php/_std/Math.hx:52: characters 3-23
		return tan($v);
	}
