...
class ValueException extends Exception {
	...
	public function __construct ($value, $previous = null, $native = null) {
		#/opt/haxe/std/haxe/ValueException.hx:24: characters 3-100
		parent::__construct(\Std::string($value), $previous, $native);
		#/opt/haxe/std/haxe/ValueException.hx:25: characters 3-21
		$this->value = $value;
	}
	...
	public function unwrap () {
		#/opt/haxe/std/haxe/ValueException.hx:36: characters 3-15
		return $this->value;
	}
}
