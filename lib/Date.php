...
final class Date {
	...
	public static function fromPhpTime ($t) {
		#/opt/haxe/std/php/_std/Date.hx:112: characters 3-41
		$d = new Date(2000, 1, 1, 0, 0, 0);
		#/opt/haxe/std/php/_std/Date.hx:113: characters 3-12
		$d->__t = $t;
		#/opt/haxe/std/php/_std/Date.hx:114: characters 3-11
		return $d;
	}
	...
	public static function fromString ($s) {
		#/opt/haxe/std/php/_std/Date.hx:124: characters 11-19
		$__hx__switch = (mb_strlen($s));
		if ($__hx__switch === 8) {
			#/opt/haxe/std/php/_std/Date.hx:126: characters 5-26
			$k = HxString::split($s, ":");
			#/opt/haxe/std/php/_std/Date.hx:127: characters 5-115
			...
			#/opt/haxe/std/php/_std/Date.hx:129: characters 5-26
			$k = HxString::split($s, "-");
			#/opt/haxe/std/php/_std/Date.hx:130: characters 21-39
			$tmp = \Std::parseInt(($k->arr[0] ?? null));
			#/opt/haxe/std/php/_std/Date.hx:130: characters 41-63
			$tmp1 = \Std::parseInt(($k->arr[1] ?? null)) - 1;
			#/opt/haxe/std/php/_std/Date.hx:130: characters 5-93
			return new Date($tmp, $tmp1, \Std::parseInt(($k->arr[2] ?? null)), 0, 0, 0);
		} else if ($__hx__switch === 19) {
			#/opt/haxe/std/php/_std/Date.hx:132: characters 5-26
			$k = HxString::split($s, " ");
			#/opt/haxe/std/php/_std/Date.hx:133: characters 5-29
			$y = HxString::split(($k->arr[0] ?? null), "-");
			#/opt/haxe/std/php/_std/Date.hx:134: characters 5-29
			$t = HxString::split(($k->arr[1] ?? null), ":");
			#/opt/haxe/std/php/_std/Date.hx:135: characters 21-39
			$tmp = \Std::parseInt(($y->arr[0] ?? null));
			#/opt/haxe/std/php/_std/Date.hx:135: characters 41-63
			$tmp1 = \Std::parseInt(($y->arr[1] ?? null)) - 1;
			#/opt/haxe/std/php/_std/Date.hx:135: characters 65-83
			$tmp2 = \Std::parseInt(($y->arr[2] ?? null));
			#/opt/haxe/std/php/_std/Date.hx:135: characters 85-103
			$tmp3 = \Std::parseInt(($t->arr[0] ?? null));
			#/opt/haxe/std/php/_std/Date.hx:135: characters 105-123
			$tmp4 = \Std::parseInt(($t->arr[1] ?? null));
			#/opt/haxe/std/php/_std/Date.hx:135: characters 5-144
			return new Date($tmp, $tmp1, $tmp2, $tmp3, $tmp4, \Std::parseInt(($t->arr[2] ?? null)));
		} else {
			#/opt/haxe/std/php/_std/Date.hx:137: characters 5-10
	...
	public static function fromTime ($t) {
		#/opt/haxe/std/php/_std/Date.hx:118: characters 3-41
		$d = new Date(2000, 1, 1, 0, 0, 0);
		#/opt/haxe/std/php/_std/Date.hx:119: characters 3-19
		$d->__t = $t / 1000;
		#/opt/haxe/std/php/_std/Date.hx:120: characters 3-11
		return $d;
	}
	...
	public static function now () {
		#/opt/haxe/std/php/_std/Date.hx:108: characters 3-48
	...
	public function __construct ($year, $month, $day, $hour, $min, $sec) {
		#/opt/haxe/std/php/_std/Date.hx:30: characters 3-53
	...
	public function getDate () {
		#/opt/haxe/std/php/_std/Date.hx:51: characters 10-34
	...
	public function getDay () {
		#/opt/haxe/std/php/_std/Date.hx:67: characters 10-34
	...
	public function getFullYear () {
		#/opt/haxe/std/php/_std/Date.hx:42: characters 10-34
	...
	public function getHours () {
		#/opt/haxe/std/php/_std/Date.hx:55: characters 10-34
	...
	public function getMinutes () {
		#/opt/haxe/std/php/_std/Date.hx:59: characters 10-34
	...
	public function getMonth () {
		#/opt/haxe/std/php/_std/Date.hx:46: characters 3-40
		$m = (int)(date("n", (int)($this->__t)));
		#/opt/haxe/std/php/_std/Date.hx:47: characters 3-16
		return -1 + $m;
	}
	...
	public function getPhpTime () {
		#/opt/haxe/std/php/_std/Date.hx:38: characters 3-13
		return $this->__t;
	}
	...
	public function getSeconds () {
		#/opt/haxe/std/php/_std/Date.hx:63: characters 10-34
	...
	public function getTime () {
		#/opt/haxe/std/php/_std/Date.hx:34: characters 3-22
	...
	public function getTimezoneOffset () {
		#/opt/haxe/std/php/_std/Date.hx:100: characters 3-49
	...
	public function getUTCDate () {
		#/opt/haxe/std/php/_std/Date.hx:80: characters 10-36
	...
	public function getUTCDay () {
		#/opt/haxe/std/php/_std/Date.hx:96: characters 10-36
	...
	public function getUTCFullYear () {
		#/opt/haxe/std/php/_std/Date.hx:71: characters 10-36
	...
	public function getUTCHours () {
		#/opt/haxe/std/php/_std/Date.hx:84: characters 10-36
	...
	public function getUTCMinutes () {
		#/opt/haxe/std/php/_std/Date.hx:88: characters 10-36
	...
	public function getUTCMonth () {
		#/opt/haxe/std/php/_std/Date.hx:75: characters 3-42
		$m = (int)(gmdate("n", (int)($this->__t)));
		#/opt/haxe/std/php/_std/Date.hx:76: characters 3-16
		return -1 + $m;
	}
	...
	public function getUTCSeconds () {
		#/opt/haxe/std/php/_std/Date.hx:92: characters 10-36
	...
	public function toString () {
		#/opt/haxe/std/php/_std/Date.hx:104: characters 3-39
