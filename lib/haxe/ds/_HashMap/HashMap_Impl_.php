...
final class HashMap_Impl_ {
	...
	public static function _new () {
		#/opt/haxe/std/haxe/ds/HashMap.hx:38: character 2
	...
	public static function clear ($this1) {
		#/opt/haxe/std/haxe/ds/HashMap.hx:107: characters 3-20
		$_this = $this1->keys;
		$this2 = [];
		$_this->data = $this2;
		#/opt/haxe/std/haxe/ds/HashMap.hx:108: characters 3-22
		$_this = $this1->values;
		$this1 = [];
		$_this->data = $this1;
	}
	...
	public static function copy ($this1) {
		#/opt/haxe/std/haxe/ds/HashMap.hx:83: characters 3-34
		$copied = new HashMapData();
		#/opt/haxe/std/haxe/ds/HashMap.hx:84: characters 3-33
		$copied->keys = (clone $this1->keys);
		#/opt/haxe/std/haxe/ds/HashMap.hx:85: characters 3-37
		$copied->values = (clone $this1->values);
		#/opt/haxe/std/haxe/ds/HashMap.hx:86: characters 3-21
		return $copied;
	}
	...
	public static function exists ($this1, $k) {
		#/opt/haxe/std/haxe/ds/HashMap.hx:61: characters 10-42
		$_this = $this1->values;
	...
	public static function get ($this1, $k) {
		#/opt/haxe/std/haxe/ds/HashMap.hx:54: characters 10-39
		$_this = $this1->values;
		$key = $k->hashCode();
	...
	public static function iterator ($this1) {
		#/opt/haxe/std/haxe/ds/HashMap.hx:93: characters 10-32
	...
	public static function keyValueIterator ($this1) {
		#/opt/haxe/std/haxe/ds/HashMap.hx:100: characters 3-48
	...
	public static function keys ($this1) {
		#/opt/haxe/std/haxe/ds/HashMap.hx:76: characters 10-30
	...
	public static function remove ($this1, $k) {
		#/opt/haxe/std/haxe/ds/HashMap.hx:68: characters 3-35
		$this1->values->remove($k->hashCode());
		#/opt/haxe/std/haxe/ds/HashMap.hx:69: characters 3-40
	...
	public static function set ($this1, $k, $v) {
		#/opt/haxe/std/haxe/ds/HashMap.hx:46: characters 3-33
		$_this = $this1->keys;
		$key = $k->hashCode();
		$_this->data[$key] = $k;
		#/opt/haxe/std/haxe/ds/HashMap.hx:47: characters 3-35
		$_this = $this1->values;
		$key = $k->hashCode();
		$_this->data[$key] = $v;
	}
